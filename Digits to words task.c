...
int main()
{
	...
	if (count == 5)
	{
		...
		case 2:
			...
			switch (rem)
			{
			case 0: printf("\nTwenty thousand ");       break;
			case 1: printf("\nTwenty one thousand ");   break;
			case 2: printf("\nTwenty two thousand ");   break;
			case 3: printf("\nTwenty three thousand "); break;
			case 4: printf("\nTwenty four thousand ");  break;
			case 5: printf("\nTwenty five thousand ");  break;
			case 6: printf("\nTwenty six thousand ");   break;
			case 7: printf("\nTwenty seven thousand "); break;
			case 8: printf("\nTwenty eight thousand "); break;
			case 9: printf("\nTwenty nine thousand ");  break;
			default:                                    break;
			}break; 
		...
		case 3: 
			...
			switch (rem)
			{
			case 0: printf("\nThirty thousand ");       break;
			case 1: printf("\nThirty one thousand ");   break;
			case 2: printf("\nThirty two thousand ");   break;
			case 3: printf("\nThirty three thousand "); break;
			case 4: printf("\nThirty four thousand ");  break;
			case 5: printf("\nThirty five thousand ");  break;
			case 6: printf("\nThirty six thousand ");   break;
			case 7: printf("\nThirty seven thousand "); break;
			case 8: printf("\nThirty eight thousand "); break;
			case 9: printf("\nThirty nine thousand ");  break;
			default:                                    break;
			}break; 
		...
		case 4: 
			...
			switch (rem)
			{
			case 0: printf("\nForty thousand ");       break;
			case 1: printf("\nForty one thousand ");   break;
			case 2: printf("\nForty two thousand ");   break;
			case 3: printf("\nForty three thousand "); break;
			case 4: printf("\nForty four thousand ");  break;
			case 5: printf("\nForty five thousand ");  break;
			case 6: printf("\nForty six thousand ");   break;
			case 7: printf("\nForty seven thousand "); break;
			case 8: printf("\nForty eight thousand "); break;
			case 9: printf("\nForty nine thousand ");  break;
			default:                                   break;
			}break; 
		...
		case 5: 
			...
			switch (rem)
			{
			case 0: printf("\nFifty thousand ");       break;
			case 1: printf("\nFifty one thousand ");   break;
			case 2: printf("\nFifty two thousand ");   break;
			case 3: printf("\nFifty three thousand "); break;
			case 4: printf("\nFifty four thousand ");  break;
			case 5: printf("\nFifty five thousand ");  break;
			case 6: printf("\nFifty six thousand ");   break;
			case 7: printf("\nFifty seven thousand "); break;
			case 8: printf("\nFifty eight thousand "); break;
			case 9: printf("\nFifty nine thousand ");  break;
			default:                                   break;
			}break; 
		...
		case 6: 
			...
			switch (rem)
			{
			case 0: printf("\nSixty thousand ");       break;
			case 1: printf("\nSixty one thousand ");   break;
			case 2: printf("\nSixty two thousand ");   break;
			case 3: printf("\nSixty three thousand "); break;
			case 4: printf("\nSixty four thousand ");  break;
			case 5: printf("\nSixty five thousand ");  break;
			case 6: printf("\nSixty six thousand ");   break;
			case 7: printf("\nSixty seven thousand "); break;
			case 8: printf("\nSixty eight thousand "); break;
			case 9: printf("\nSixty nine thousand ");  break;
			default:                                   break;
			}break;  
		...
		case 7: 
			...
			switch (rem)
			{
			case 0: printf("\nSeventy thousand ");       break;
			case 1: printf("\nSeventy one thousand ");   break;
			case 2: printf("\nSeventy two thousand ");   break;
			case 3: printf("\nSeventy three thousand "); break;
			case 4: printf("\nSeventy four thousand ");  break;
			case 5: printf("\nSeventy five thousand ");  break;
			case 6: printf("\nSeventy six thousand ");   break;
			case 7: printf("\nSeventy seven thousand "); break;
			case 8: printf("\nSeventy eight thousand "); break;
			case 9: printf("\nSeventy nine thousand ");  break;
			default:                                     break;
			}break;  
		...
		case 8: 
			...
			switch (rem)
			{
			case 0: printf("\nEighty thousand ");       break;
			case 1: printf("\nEighty one thousand ");   break;
			case 2: printf("\nEighty two thousand ");   break;
			case 3: printf("\nEighty three thousand "); break;
			case 4: printf("\nEighty four thousand ");  break;
			case 5: printf("\nEighty five thousand ");  break;
			case 6: printf("\nEighty six thousand ");   break;
			case 7: printf("\nEighty seven thousand "); break;
			case 8: printf("\nEighty eight thousand "); break;
			case 9: printf("\nEighty nine thousand ");  break;
			default:                                    break;
			}break;  
		...
		case 9: 
			...
			switch (rem)
			{
			case 0: printf("\nNinty thousand ");       break;
			case 1: printf("\nNinty one thousand ");   break;
			case 2: printf("\nNinty two thousand ");   break;
			case 3: printf("\nNinty three thousand "); break;
			case 4: printf("\nNinty four thousand ");  break;
			case 5: printf("\nNinty five thousand ");  break;
			case 6: printf("\nNinty six thousand ");   break;
			case 7: printf("\nNinty seven thousand "); break;
			case 8: printf("\nNinty eight thousand "); break;
			case 9: printf("\nNinty nine thousand ");  break;
			default:                                   break;
			}break;  
		}
